namespace LeaguesharpPrediction
{
    ...
    public static class CustomEvents
    {
        ...
        public class Game
        {
            ...
            static Game()
            {
                EloBuddy.SDK.Core.DelayAction(delegate {Initialize();}, 0);
            }
            ...
            public static void Initialize()
            {
                ...
                if (EloBuddy.Game.Mode == GameMode.Running)
                {
                    ...
                    //Core.DelayAction( () => { Game_OnGameStart(new EventArgs()); });
                    EloBuddy.SDK.Core.DelayAction(delegate { Game_OnGameStart(new EventArgs()); },0);
                }
                else
                {
                    Game.OnGameLoad += Game_OnGameStart;
                }
            }
